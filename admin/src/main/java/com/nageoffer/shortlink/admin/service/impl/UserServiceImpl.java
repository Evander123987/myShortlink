...
public class UserServiceImpl extends ServiceImpl<UserMapper, UserDO> implements UserService {
    ...
    public void update(UserUpdateReqDTO requestParm) {
        ...
        baseMapper.update(BeanUtil.toBean(requestParm, UserDO.class), updateWrapper);
    }
    ...
    public UserLoginRespDTO login(UserLoginReqDTO requestParm) {
        ...
        stringRedisTemplate.expire("login_" + requestParm.getUsername(), 30L, TimeUnit.MINUTES);
